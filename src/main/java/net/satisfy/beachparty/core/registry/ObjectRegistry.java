...
public class ObjectRegistry {
    public static final Item COCONUT_OPEN = registerItem("coconut_open", Item::new, settings().food(Foods.CARROT));
    public static final Item RAW_MUSSEL_MEAT = registerItem("raw_mussel_meat", Item::new, settings().food(Foods.POTATO));
    public static final Item COOKED_MUSSEL_MEAT = registerItem("cooked_mussel_meat", Item::new, settings().food(Foods.BAKED_POTATO));
    ...
    public static final Block PALM_LEAVES = registerWithItem("palm_leaves", PalmLeavesBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES));
    public static final SaplingBlock PALM_SPROUT = registerWithItem("palm_sprout", PalmSproutBlock::new, PalmSproutBlock.sproutProperties());
    ...
    public static final Block PALM_BUTTON = registerWithItem("palm_button", p -> new ButtonBlock(BlockSetType.BAMBOO, 30, p), BlockBehaviour.Properties.of().noCollision().strength(0.5F).pushReaction(PushReaction.DESTROY));
    ...
    public static final Block PALM_CHAIR = registerWithItem("palm_chair", PalmChairBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.BAMBOO_PLANKS).pushReaction(PushReaction.IGNORE));
    ...
    public static final Block BEACH_SUN_LOUNGER = registerWithItem("beach_sun_lounger", p -> new BeachSunLounger(DyeColor.WHITE, p), BlockBehaviour.Properties.ofFullCopy(Blocks.BAMBOO_PLANKS).pushReaction(PushReaction.IGNORE).instabreak().mapColor(DyeColor.WHITE).bounceRestitution(0.25F));
    ...
    public static final Block BEACH_TOWEL = registerWithHintItem("beach_towel", p -> new BeachTowelBlock(DyeColor.WHITE, p), BlockBehaviour.Properties.ofFullCopy(Blocks.WOOL.red()).pushReaction(PushReaction.IGNORE).instabreak().mapColor(DyeColor.WHITE).bounceRestitution(0.25F));
    ...
    public static final Item MESSAGE_IN_A_BOTTLE_ITEM = registerItem("message_in_a_bottle", p -> new MessageInABottleItem(MESSAGE_IN_A_BOTTLE, p), settings());
    ...
    public static final Item SAND_BUCKET_FILLED = registerItem("sand_bucket_filled", p -> new SandBucketItem(SAND_BUCKET_BLOCK_FILLED, p), settings().stacksTo(1));
    ...
    public static final Item SAND_BUCKET_EMPTY = registerItem("sand_bucket_empty", p -> new SandBucketItem(SAND_BUCKET_BLOCK_EMPTY, p), settings());
    ...
    public static final Item COCONUT = registerItem("coconut", CoconutItem::new, settings());
    ...
    public static final Item PALM_TORCH_ITEM = registerItem("palm_torch_item", p -> new StandingAndWallBlockItem(PALM_TORCH, PALM_WALL_TORCH, Direction.DOWN, p), settings());
    ...
    public static final Item PALM_SIGN_ITEM = registerItem("palm_sign", p -> new SignItem(PALM_SIGN, PALM_WALL_SIGN, p), settings().stacksTo(16));
    public static final Item PALM_HANGING_SIGN_ITEM = registerItem("palm_hanging_sign", p -> new HangingSignItem(PALM_HANGING_SIGN, PALM_WALL_HANGING_SIGN, p), settings().stacksTo(16));
    ...
    private static Item.Properties cocktailSettings(Holder<MobEffect> effect) {
        ...
        Consumable consumable = Consumables.defaultDrink()
                ...
                .build();
        return settings().food(food, consumable);
    }
